...
\ntsetup{school=ulht/deisi}    % The school id
...
%\ntsetup{print/secondcover=false}    % Shall a second cover page be forced?
...
\ntsetup{print/statement=false}% Does the document have after cover pages??
