...
class MapScreenCopy extends StatefulWidget {
  const MapScreenCopy({super.key});

  @override
  State<MapScreenCopy> createState() => _MapScreenCopyState();
}

// Estado associado ao MapScreen. Mantém os dados necessários e a lógica para o funcionamento do mapa.
class _MapScreenCopyState extends State<MapScreenCopy> {
